...
public class AdminPersonelIslem extends javax.swing.JFrame {


    
    public AdminPersonelIslem() {
        initComponents();
        baglan();
        odaVeriGetir();
    ...
    public void odaVeriGetir() { 
     ...
     public void rezervasyonVeriGetir() { 
        ...
        try {
            ...
            ResultSetMetaData rsd = rs.getMetaData();
            c = rsd.getColumnCount();
            table = (DefaultTableModel) tblMusteri.getModel();
            table.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Admin Personel ekranı");
    ...
    private void tblMusteriMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMusteriMouseClicked
        table = (DefaultTableModel) tblMusteri.getModel(); 
        int selectedIndex = tblMusteri.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new AdminPersonelIslem().setVisible(true);
            }
        });
    }
